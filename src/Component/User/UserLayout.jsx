...
const UserLayout = ({ children }) => {
  const navItems = [
    ...
    { title: "Home", to:"/UserHome", className: "nav-item btvikass", icon: <TbAlertSquareFilled /> },
    { title: "View", to:"/UserView", className: "nav-item btvikass", icon: <FaRecycle /> },
    { title: "About Us", to:"#", className: "nav-item btvikass", icon: <MdDashboard/>},
    { title: "Contact Us", to:"#", className: "nav-item btvikass", icon: <TbAlertSquareFilled /> },
