...
import Layout from '../staff/StaffLayout'
   ...
   <>
    <Layout>
       <div className='row'>
        ...
        <h3 className='text-center '>Form <span className='text-success mt-3 mb-4 '>Update</span></h3>
      ...
      <input type="submit" className='form-control  mb-3 btn btn-success' value={"Submit"} />
    </form>
        </div>
       </div>
    </Layout>
